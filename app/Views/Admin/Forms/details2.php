    ...
    <div class="page">
        <div class="content">
            ...
            <div>
                ...
                <p>The undersigned hereby applies for a license under the provisions of Chapter IV, Title I of the
                    Insurance Code, to act as insurance/general agent of <ins style="font-weight:bold;">Allianz PNB Life
                        Insurance, Inc</ins> in respect of the kind of insurance indicated herein:
                </p>
            </div>
            <div class="insurancecheck">
                ...
                <input type="checkbox" name="" id="" <?= isset($aial['accidentAndHealth']) && $aial['accidentAndHealth'] === 'accidentAndHealth' ? 'checked' : '' ?>> <label for="">ACCIDENT AND HEALTH</label>

                <input type="checkbox" name="" id="" style="margin-left: 140px;" <?= isset($aial['others']) && $aial['others'] === 'others' ? 'checked' : '' ?>><label for=""
                    style="margin-right: 0;">Others (please specify)</label> <input type="text" name="" id="" value="<?= isset($aial['othersSpecification']) ? $aial['othersSpecification'] : '' ?>">
            </div>
            <div>
                ...
                <div style="justify-items: center; text-align: center;">
                    <input type="text" name="" id="" style="width: 300px;" value="<?= isset($aial['agencyName']) ? $aial['agencyName'] : '' ?>"><br>
                    <label for="">(Agency Name if any)</label>
                </div>
            </div>
            <div style="justify-content: space-between;">
                <ol start="1" style="padding-left: 15px;">
                    <li>Name of Applicant:<input type="text" name="" id="" style="width: 495px;" value="<?= isset($aial['surname']) ? $aial['surname'] : '' ?>, <?= isset($aial['firstName']) ? $aial['firstName'] : '' ?>, <?= isset($aial['middleName']) ? $aial['middleName'] : '' ?>."></li>
            ...
            <div>
                ...
                <input type="text" name="" id="" style="width: 395px;" value="<?= isset($aial['homeAddress']) ? $aial['homeAddress'] : '' ?>">
                <label for="">Zip: </label>
                <input type="text" name="" id="" style="width: 80px;" value="<?= isset($aial['zipCode']) ? $aial['zipCode'] : '' ?>">
            </div>
            <div>
                <ul><label for="">Business address:</label><input type="text" name="" id="" style="width: 470px;" value="<?= isset($aial['businessAddress']) ? $aial['businessAddress'] : '' ?>"></ul>
                <ul><label for="">TIN: </label><input type="text" name="" id=""
                        style="margin-right: 20px; width: 220px" value="<?= isset($aial['tin']) ? $aial['tin'] : '' ?>">
                    <label for="">Email Adress:</label><input type="text" name="" id="" style="width: 220px;" value="<?= isset($aial['email']) ? $aial['email'] : '' ?>">
                </ul>
            </div>
            <div style="margin-left: 320px;">
                <label for="">Mobile Number:</label><input type="text" name="" id="" style="width: 200px;" value="<?= isset($aial['mobileNumber']) ? $aial['mobileNumber'] : '' ?>">
            </div>
            <div>
                ...
                <label for="">b) Place:</label><input type="text" name="" id="" style="width: 245px;" value="<?= isset($aial['birthPlace']) ? $aial['birthPlace'] : '' ?>">
            </div>
            <div>
                ...
                <label for="">Sex: </label><input type="text" name="" id="" style="width: 100px;" value="<?= isset($aial['sex']) ? $aial['sex'] : '' ?>">
                <label for="">Civil Status: </label><input type="text" name="" id="" style="width: 186px;" style="width: 435px;" value="<?= isset($aial['civilStatus']) ? $aial['civilStatus'] : '' ?>">
            </div>
            <div>
                ...
                <ol start="7" style="padding-left: 15px;">
                    <li>If naturalized citizen of the Philippines, give date and
                        ...
                        naturalization and attach photocopy of certificate of naturalization. <input type="text" name=""
                            id="" value="<?= isset($aial['naturalizationDetails']) ? $aial['naturalizationDetails'] : 'N/A' ?>"></li>
                </ol>
            </div>
            <hr class="dashed-hr">
            <div class="IConly">
            ...
            <ol start="8" style="padding-left: 15px;">
                <li>If applicant is a foreigner, give serial number, date and place of issue
                    ...
                    photocopy of each thereof</label><input type="text" name="" id="" value="<?= isset($aial['foreignerDetails']) ? $aial['foreignerDetails'] : 'N/A' ?>"> </li>
            </ol>
            ...
            <div style="margin-left: .2in;">
                <ol type="a">
                    <li> Attach a certified true copy of the certificate of registration, articles of partnership,
                        association or incorporation and by-laws: <input type="text" name="" id="" value="<?= isset($aial['certifiedCopyDetails']) ? $aial['certifiedCopyDetails'] : 'N/A' ?>"
                            style="width: 280px;"></li>
                    <li>State percentage of Filipino participation in the partnership, association or corporation:
                    </li>
                    <input type="text" name="" id="" value="<?= isset($aial['filipinoParticipation']) ? $aial['filipinoParticipation'] : 'N/A' ?>" style="width: 550px;">
                </ol>
            </div>
            ...
            <table border="1">
                ...
                <tbody>
                    <tr>
                        <td><input type="text" name="" id="" value="N/A"></td>
            ...
            <div>
                Executed this<input type="text" name="" id="" style="width: 50px;">day of <input type="text" name=""
                    id="" style="width: px;">20<input type="text" name="" id="" style="width: 50px;">, at <input
                    type="text" name="" id="" style="width: 180px;">
            </div>
            <br>
            <br>
            <div style="text-align: right; ">
                <input type="text" name="" id="" style="width: 190px;"><br>
            ...
            <div>
                ...
                Province/City of <input type="text" name="" id="" style="width: 65px;">)S.S
            </div>
            <div>
                I. <input type="text" name="" id="" style="width: 280px;">, being duly sworn, depose and say that I am
                the
            ...
            <p style="text-indent: 40px;">SUBSCRIBED AND SWORN TO before me this <input type="text" name="" id=""
                    style="width: 40px;"> day of <input type="text" name="" id="" style="width: 120px;">20 <input
                    type="text" name="" id="" style="width: 40px;">Affiant/s exhibited to me his/her
                TIN/SSS/Passport/Postal/LTO/<input type="text" name="" id="" style="width: 225px;"></p>
            <br><br>
            ...
            <div>
                ...
                <div>
                    <p style="text-indent: 0.5in">Executed in <input type="text" name="" id="">on<input style="width: 316px;" type="text" name="" id=""></p>
                </div>
                ...
                <div style="text-align: justify; font-size: 8pt;">
                    N.B. No person, partnership, association or corporation required by Law to file an income tax return shall be
                    issued a license to engage in any trade, business or occupation o practice a profession unless he shall have
                    presented to the officer issuing such license or permit proof that he has filed his income tax return during the
                    preceding year and that income taxes due have been paid thereon. For the purpose of this Act, a copy of such
                    income tax return on which is shown a certification or statement by the Collector of Internal Revenue or his duty
                    authorized representative that the aforesaid income tax return, and the corresponding receipts showing payment
                ...
                <div style="text-align: justify;font-size: 8pt;">
                    ...
                    without presenting the aforementioned certification of the Collector of Internal Revenue or his duly authorized
                    representative, under the pretext that he or it is not required by law to file an income tax return when in truth he or
                    it is so required, or under any other misrepresentation, shall be liable to fine of not more than Five Hundred
                    Pesos, or imprisonment of not more than one year or both, in the discretion of the Court. In case of partnership,
                    association, the manager or the equivalent officer thereof shall be held responsible and in addition, the license
