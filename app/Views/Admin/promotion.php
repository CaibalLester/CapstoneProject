            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-3 d-md-block sidebar collapse">
                <div class="position-sticky py-4 px-3 sidebar-sticky">
                    <ul class="nav flex-column h-100">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="/promotion">
                                <i class="fa fa-user me-2"></i>
                                Promotion
                            </a>
                        </li>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-7 col-md-8 col-12">
                                                <form class="custom-form search-form" action="promotion" method="post"
                                                    role="form">
                                                    <div class="row">
                                            ...
                                            <?php foreach ($applicant as $app): ?>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="newAgent/<?= $app['app_token'] ?>"
                                                                class="btn btn-secondary"
                                                                onclick="return confirm('Are you sure you want to promote <?= $app['username'] ?> to Agent?');">
