...
<html lang="en">
	...
	<body data-spy="scroll" data-target=".navbar" data-offset="50">
		...
		<nav class="navbar navbar-expand-lg fixed-top">
			<div class="container">
				<a class="navbar-brand" href="#"><h3 class="font-weight-medium">ALLIANZ PNB</h3></a>
						...
						<div class="col-sm-12">
							<div class="d-sm-flex justify-content-between align-items-center mb-2">
								<div>
									...
									<h5 class="text-dark ">Allianz boasts a dedicated and experienced team committed to delivering unparalleled financial and insurance solutions, ensuring the security and prosperity of their clients. </h5>
								</div>
								</div>
							</div>
						</div>
