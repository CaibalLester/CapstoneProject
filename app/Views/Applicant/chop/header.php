...
<div class="col-md-3 col-lg-3 me-0 px-2 fs-6 col-4">
        <a class="navbar-brand" href="/AppDash">
            ALLIANZ APPLICANT
        </a>
    </div>
        ...
        <div class="nav-item text-nowrap d-flex align-items-center">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-4">
                                <a class="dropdown-item text-center" href="#">
                                    <img src="Applicants/images/social/search.png" class="profile-image img-fluid"
                                        alt="">
                            ...
                            <div class="col-lg-4 col-md-4 col-4">
                                <a class="dropdown-item text-center" href="#">
                                    <img src="Applicants/images/social/spotify.png" class="profile-image img-fluid"
                                        alt="">
                            ...
                            <div class="col-lg-4 col-md-4 col-4">
                                <a class="dropdown-item text-center" href="#">
                                    <img src="Applicants/images/social/telegram.png" class="profile-image img-fluid"
                                        alt="">
                            ...
                            <div class="col-lg-4 col-md-4 col-4">
                                <a class="dropdown-item text-center" href="#">
                                    <img src="Applicants/images/social/snapchat.png" class="profile-image img-fluid"
                                        alt="">
                            ...
                            <div class="col-lg-4 col-md-4 col-4">
                                <a class="dropdown-item text-center" href="#">
                                    <img src="Applicants/images/social/tiktok.png" class="profile-image img-fluid"
                                        alt="">
                            ...
                            <div class="col-lg-4 col-md-4 col-4">
                                <a class="dropdown-item text-center" href="#">
                                    <img src="Applicants/images/social/youtube.png" class="profile-image img-fluid"
                                        alt="">
            ...
            <div class="dropdown px-3">
                <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                    aria-expanded="false">
                    <img src="<?= isset($applicant['profile']) && !empty($applicant['profile']) ? base_url('/uploads/' . $applicant['profile']) : base_url('/uploads/def.png') ?>" class="profile-image img-fluid" alt="">
                </a>
