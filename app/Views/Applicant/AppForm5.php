                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-4">
                                    <a class="dropdown-item text-center" href="#">
                                        <img src="AdminInfo/images/social/search.png" class="profile-image img-fluid"
                                            alt="">
                                ...
                                <div class="col-lg-4 col-md-4 col-4">
                                    <a class="dropdown-item text-center" href="#">
                                        <img src="AdminInfo/images/social/spotify.png" class="profile-image img-fluid"
                                            alt="">
                                ...
                                <div class="col-lg-4 col-md-4 col-4">
                                    <a class="dropdown-item text-center" href="#">
                                        <img src="AdminInfo/images/social/telegram.png" class="profile-image img-fluid"
                                            alt="">
                                ...
                                <div class="col-lg-4 col-md-4 col-4">
                                    <a class="dropdown-item text-center" href="#">
                                        <img src="AdminInfo/images/social/snapchat.png" class="profile-image img-fluid"
                                            alt="">
                                ...
                                <div class="col-lg-4 col-md-4 col-4">
                                    <a class="dropdown-item text-center" href="#">
                                        <img src="AdminInfo/images/social/tiktok.png" class="profile-image img-fluid"
                                            alt="">
                                ...
                                <div class="col-lg-4 col-md-4 col-4">
                                    <a class="dropdown-item text-center" href="#">
                                        <img src="AdminInfo/images/social/youtube.png" class="profile-image img-fluid"
                                            alt="">
                            ...
                            <div class="collapse" id="manageDropdown">
                                <ul class="nav">
                                    <li class="nav-item">
                                        ...
                                        <a class="nav-link active" href="/AppForm5">
                                            <i class="bi-pen me-2"></i>
