                                    ...
                                    <form class="custom-form profile-form" action="/svap" method="post"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 text-center">
                                                ...
                                                <input class="form-control text-center text-center" type="date"
                                                    name="birthday" placeholder="Please Enter your Birthday mm/dd/yyyy"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 text-center">
                                                ...
                                                <select class="form-control text-center" name="province" id="province">
                                            ...
                                            <div class="col-md-3 text-center">
                                                ...
                                                <select class="form-control text-center" name="city" id="city">
                                                    <option value="city1">City/Municipality 1</option>
                                                    <option value="city2">City/Municipality 2</option>
                                                    <!-- Add more cities/municipalities as needed -->
                                                </select>
                                            </div>
                                            <div class="col-md-3 text-center">
                                                <label for="barangay" class="small">Barangay</label>
                                                <select class="form-control text-center" name="barangay" id="barangay">
