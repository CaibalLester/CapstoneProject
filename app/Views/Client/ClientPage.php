...
<!-- Mirrored from templates.hibootstrap.com/inon/default/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Mar 2024 12:34:39 GMT -->
...
<body>
				...
				<nav class="navbar navbar-expand-md navbar-light">
					...
					<div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
						<ul class="navbar-nav ms-auto">
								...
								<ul class="dropdown-menu">
									...
									<li class="nav-item">
										...
										<ul class="dropdown-menu">
											...
											<li class="nav-item">
												<a href="servicesdetails" class="nav-link">Services Details</a>
											</li>
										</ul>
									</li>
									<li class="nav-item">
							...
							<li class="nav-item">
								<a href="/client/login" class="nav-link">Login</a>
							</li>
						</ul>
			...
			<div class="row align-items-center">
				<div class="col-lg-7">
					<div class="single-banner-three-content">
						...
						<h1>Trusted Insurance For Any Purpose</h1>
						<p>On the other hand, we denounce with righteous indignation and dislike men who are so beguiled
							adem ralized by the charms of pleasure hand, we denounce with righteous indignation and
							dislike men.</p>
						<div class="banner-btn d-flex align-items-center">
							<a href="about.html" class="default-btn btn-style-3">Get Started</a>
							<a href="about.html" class="default-btn btn-style30">Contact Us</a>
						</div>
					</div>
				</div>
				<div class="col-lg-5">
					<div class="single-banner-3-img">
						<div class="banner-three-img1" data-cue="slideInLeft" data-duration="500">
							<img src="client/assets/images/banner/banner-three-img-1.webp" alt="banner">
						</div>
						<div class="banner-three-img2" data-cue="slideInRight" data-duration="1000">
							<img src="client/assets/images/banner/banner-three-img-2.webp" alt="banner">
						</div>
						<div class="banner-three-img3" data-cue="slideInUp" data-duration="1500">
							<img src="client/assets/images/banner/banner-three-img-3.webp" alt="banner">
						</div>
						<div class="banner-three-img4" data-cue="slideInLeft" data-duration="2000">
							<img src="client/assets/images/banner/banner-three-img-4.webp" alt="banner">
						</div>
						<div class="banner-three-img5" data-cue="zoomIn" data-duration="2500">
							<img src="client/assets/images/banner/banner-three-img-5.webp" alt="banner">
						</div>
						<div class="banner-three-main">
							<img src="client/assets/images/banner/banner-three-main.webp" alt="banner">
						</div>
					</div>
				</div>
			</div>
		</div>
		<div class="banner-three-img6">
			<img src="client/assets/images/banner/banner-three-img-6.webp" alt="banner-shape">
		</div>
		<div class="banner-three-img7">
			<img src="client/assets/images/banner/banner-three-img-7.webp" alt="banner-shape">
		</div>
		<div class="banner-three-img8">
			<img src="client/assets/images/banner/banner-three-img-8.webp" alt="banner-shape">
		</div>
		<div class="banner-three-img9">
			<img src="client/assets/images/banner/banner-three-img-9.webp" alt="banner-shape">
		</div>
		<div class="banner-three-img10">
			<img src="client/assets/images/banner/banner-three-img-10.webp" alt="banner-shape">
		</div>
		<div class="banner-three-img11">
			<img src="client/assets/images/banner/banner-three-img-11.webp" alt="banner-shape">
		</div>
		<div class="banner-three-img12">
			<img src="client/assets/images/banner/banner-three-img-12.webp" alt="banner-shape">
		</div>
		<div class="banner-three-img13">
			<img src="client/assets/images/banner/banner-three-img-9.webp" alt="banner-shape">
		</div>
		<div class="banner-three-img14">
			<img src="client/assets/images/banner/banner-three-img-10.webp" alt="banner-shape">
		</div>
	</div>
	...
	<div class="about-three-area pb-100">
		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-6">
					<div class="about-three-img">
						<img src="client/assets/images/about/about-three.webp" alt="about">
					</div>
				</div>
				<div class="col-lg-6">
					<div class="single-about-three-content">
						<div class="section-title left-title">
							<span class="top-title">About Us</span>
							<h2>The World’s Best Inon Life Insurance Company</h2>
						...
						<div class="row">
							<div class="col-lg-6 col-sm-6 col-md-6">
								<div class="about-three-list">
									<img src="client/assets/images/about/about-three-check.svg" alt="check"> Pine & Associates
									Insurance
								</div>
								<div class="about-three-list">
									<img src="client/assets/images/about/about-three-check.svg" alt="check"> Amount of Payment
								</div>
							</div>
							<div class="col-lg-6 col-sm-6 col-md-6">
								<div class="about-three-list">
									<img src="client/assets/images/about/about-three-check.svg" alt="check"> Payment at
									Contingency
								</div>
								<div class="about-three-list">
									<img src="client/assets/images/about/about-three-check.svg" alt="check"> We Can Save You
									Money
								</div>
							</div>
						</div>
						<a href="about-2.html" class="default-btn">Read More</a>
					</div>
				</div>
			</div>
		</div>
		<div class="about-three-shape">
			<img src="client/assets/images/about/about-three-shape-1.webp" alt="about-shape">
		</div>
		<div class="about-three-shape2">
			<img src="client/assets/images/about/about-three-shape-2.webp" alt="about-shape">
		</div>
	</div>


	<div class="panther-three-area pt-100 pb-100">
		<div class="container">
			<div class="panther-item-three">
				<div class="panther-content d-flex align-items-center justify-content-center">
					Trusted By Over
					<h2>
						<span class="odometer" data-count="35,857">00</span>
						<span class="target">+</span>
					</h2>
					Happy Customers Including
				</div>
				<div class="panther-slider-two owl-carousel owl-theme">
					<div class="panther-logo">
						<img src="client/assets/images/pantner/pantner-logo-1.webp" alt="panther-logo">
					</div>
					<div class="panther-logo">
						<img src="client/assets/images/pantner/pantner-logo-2.webp" alt="panther-logo">
					</div>
					<div class="panther-logo">
						<img src="client/assets/images/pantner/pantner-logo-3.webp" alt="panther-logo">
					</div>
					<div class="panther-logo">
						<img src="client/assets/images/pantner/pantner-logo-4.webp" alt="panther-logo">
					</div>
					<div class="panther-logo">
						<img src="client/assets/images/pantner/pantner-logo-5.webp" alt="panther-logo">
					</div>
					<div class="panther-logo">
						<img src="client/assets/images/pantner/pantner-logo-1.webp" alt="panther-logo">
					</div>
	...
	<div class="services-three-area pt-100 pb-70">
		<div class="container">
			<div class="section-title">
				<span class="top-title">Our Services</span>
				<h2>Inon Best Insurance Services</h2>
			</div>
			<div class="services-three-slider owl-carousel owl-theme">
				<div class="services-three-card">
					<div class="services-card d-flex align-items-center">
						<div class="services-icon">
							<img src="client/assets/images/services/couple.svg" alt="couple">
						</div>
						<h3><a href="services-details-2.html">Life Insurance</a></h3>
					</div>
					<p>Nsectetur adipiscing elit, sed do eiusmod to incididunt ut labore et dolore magna aliqtirt enim
						ad minim veniam, quisexercitation.</p>
				...
				<div class="services-three-card">
					<div class="services-card d-flex align-items-center">
						...
						<h3><a href="services-details-2.html">Home Insurance</a></h3>
					</div>
					<p>Nsectetur adipiscing elit, sed do eiusmod to incididunt ut labore et dolore magna aliqtirt enim
						ad minim veniam, quisexercitation.</p>
					<a href="services-details.html" class="default-btn">Read More</a>
				...
				<div class="services-three-card">
					<div class="services-card d-flex align-items-center">
						...
						<h3><a href="services-details-2.html">Health Insurance</a></h3>
					</div>
					<p>Nsectetur adipiscing elit, sed do eiusmod to incididunt ut labore et dolore magna aliqtirt enim
						ad minim veniam, quisexercitation.</p>
					<a href="services-details.html" class="default-btn">Read More</a>
				...
				<div class="services-three-card">
					<div class="services-card d-flex align-items-center">
						...
						<h3><a href="services-details-2.html">Business Insurance</a></h3>
					</div>
					<p>Nsectetur adipiscing elit, sed do eiusmod to incididunt ut labore et dolore magna aliqtirt enim
						ad minim veniam, quisexercitation.</p>
					<a href="services-details.html" class="default-btn">Read More</a>
				...
				<div class="services-three-card">
					<div class="services-card d-flex align-items-center">
						...
						<h3><a href="services-details-2.html">Car Insurance</a></h3>
					</div>
					<p>Nsectetur adipiscing elit, sed do eiusmod to incididunt ut labore et dolore magna aliqtirt enim
						ad minim veniam, quisexercitation.</p>
					<a href="services-details.html" class="default-btn">Read More</a>
				...
				<div class="services-three-card">
					<div class="services-card d-flex align-items-center">
						...
						<h3><a href="services-details-2.html">Travel Insurance</a></h3>
					</div>
					<p>Nsectetur adipiscing elit, sed do eiusmod to incididunt ut labore et dolore magna aliqtirt enim
						ad minim veniam, quisexercitation.</p>
					<a href="services-details.html" class="default-btn">Read More</a>
			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="free-quote-image-three">
						<img src="client/assets/images/free-quote-three.webp" alt="free-quote">
						<div class="free-quote-three-shape-1">
							<img src="client/assets/images/free-quote-three-shape-1.webp" alt="free-quote">
						</div>
						<div class="free-quote-three-shape-2">
							<img src="client/assets/images/free-quote-three-shape-2.webp" alt="free-quote">
						</div>
	...
	<div class="subscribe-two-area pt-100">
				...
				<div class="col-lg-6 col-md-6">
					<div class="subscribe-from">
						...
						<div class="subscribe-shape">
							<img src="client/assets/images/subscribe-2-shape-1.webp" alt="subscribe1">
						</div>
						<div class="subscribe-shape13">
							<img src="client/assets/images/subscribe-2-shape-2.webp" alt="subscribe1">
						</div>
					</div>
				</div>
			</div>
		...
		<div class="subscribe-shape-2">
			<img src="client/assets/images/subscribe-2-shape-3.webp" alt="subscribe-2-shape-3">
		</div>
	</div>
	...
	<div class="testimonials-area testimonials-two-area pt-100 pb-70">
			...
			<div class="testimonials-three-slider owl-carousel owl-theme">
				<div class="testimonials-item">
					<div class="testimonials-client d-flex align-items-center">
						<img src="client/assets/images/testimonials/testimonials-img-4.webp" alt="testimonials">
					...
					<div class="testimonials-card testimonials-card-three">
						<div class="quote-icon">
							<img src="client/assets/images/testimonials/quote.svg" class="quote1" alt="quote">
							<div class="quote-icon-2">
								<img src="client/assets/images/quote-two.svg" alt="quote">
							</div>
						</div>
						<p>Which is the same as saying through shrinking from toil and pain is
							cases are perfectly simple and easy to distinguish in a free hour whenour power of choice is
							untrammelled and when nothing.</p>
					</div>
				</div>
				<div class="testimonials-item">
					<div class="testimonials-client d-flex align-items-center">
						<img src="client/assets/images/testimonials/testimonials-img-3.webp" alt="testimonials">
						<div class="testimonials-text">
				...
				<div class="testimonials-item">
					<div class="testimonials-client d-flex align-items-center">
						<img src="client/assets/images/testimonials/testimonials-img-2.webp" alt="testimonials">
						<div class="testimonials-text">
							<h3>Ash Wednesday</h3>
							<p>Web Developer</p>
						</div>
		...
		<div class="testimonials-3-shape" data-cue="zoomIn" data-duration="2000">
			<img src="client/assets/images/testimonials/testimonials-3-shape.webp" alt="testimonials">
		</div>
	</div>
			...
			<div class="row justify-content-center">
					...
					<div class="single-blog-card blog-card-three">
						<div class="blog-img">
							<a href="blog-details.html">
								<img src="client/assets/images/blog/blog-three-img-1.webp" alt="blog">
							</a>
						</div>
						<div class="date">
						...
						<div class="single-blog-content">
							<ul class="p-0 m-0">
								<li class="list-inline">
									<div class="admin">
										<img src="client/assets/images/blog/admin.svg" alt="admin">
									</div>
									By<a href="author.html">Admin</a>
								</li>
								<li class="list-inline">
									<div class="admin">
										<img src="client/assets/images/blog/comment.svg" alt="comment">
									</div>
									No Comment
								</li>
							</ul>
				...
				<div class="col-lg-4 col-md-6">
					<div class="single-blog-card blog-card-three">
						<div class="blog-img">
							<a href="blog-details.html">
								<img src="client/assets/images/blog/blog-three-img-2.webp" alt="blog">
							</a>
						</div>
						<div class="date">
				...
				<div class="col-lg-4 col-md-6">
					<div class="single-blog-card blog-card-three">
						<div class="blog-img">
							<a href="blog-details.html">
								<img src="client/assets/images/blog/blog-three-img-3.webp" alt="blog">
							</a>
						</div>
						<div class="date">
	...
	<div class="footer-area pt-100">
			...
			<div class="row pb-100">
				<div class="col-lg-3 col-sm-6 col-md-6" data-cue="slideInUp">
					<div class="footer-widget">
						<a href="index.html">
							<img src="client/assets/images/black-logo.webp" class="black-logo" alt="logo">
							<img src="client/assets/images/white-logo.webp" class="white-logo" alt="logo">
						</a>
					...
					<div class="footer-widget">
						...
						<div class="touch-content">
							<div class="contact-icon">
								<img src="client/assets/images/contact-phone.svg" alt="svg">
							</div>
						...
						<div class="touch-content">
							<div class="contact-icon">
								<img src="client/assets/images/contact-map.svg" alt="svg">
							</div>
		...
		<div class="footer-shape-1">
			<img src="client/assets/images/footer-shape-1.webp" alt="footer">
		</div>
		<div class="footer-shape-2">
			<img src="client/assets/images/footer-shape-3.webp" alt="footer">
		</div>
...
<!-- Mirrored from templates.hibootstrap.com/inon/default/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Mar 2024 12:34:49 GMT -->
