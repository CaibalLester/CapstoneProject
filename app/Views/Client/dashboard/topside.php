<header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="/ClientPage" class="logo d-flex align-items-center">
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            <li class="dropdown-header">
              <h6><?php echo isset ($client['username']) ? $client['username'] : '' ?></h6>
              <span><?php echo isset ($user['role']) ? $user['role'] : '' ?></span>
            </li>
            <li>
              <hr class="dropdown-divider">
            </li>
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="clientprofile">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <!-- <li class="nav-item">
        ...
        <ul id="icons-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="">
              <i class=""></i><span>Remix Icons</span>
            </a>
          </li>
          <li>
            <a href="">
      ...
      <!-- <li class="nav-item">
        <a class="nav-link collapsed" href="clientprofile">
          <i class="bi bi-person"></i>
          <span>Profile</span>
        </a>
