                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="referralBy" name="referralBy" class="form-control" required>
                                                    <option value="<?= $lifechangerform['referralBy']; ?>" disabled
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-3 justify-content-center text-center">
                                                    <div class="row">
                                                        <div class="col">
                                                            ...
                                                            <span>YES</span>
                                                            <input type="checkbox" name="g1n" value="no"
                                                                <?= isset($lifechangerform['g1n']) && $lifechangerform['g1n'] === 'no' ? 'checked' : '' ?>>
                                                            <span>NO</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-8 mb-2">
                                                    <div class="row">
                                                        <label for="">Have you ever been accused, investigated/arrested,
                                                            indicated or convicted of any criminal or civil case? If
                                                            yes, please provide details: <input class="tb" type="text"
                                                                name="accused" id=""
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-3 justify-content-center text-center">
                                                    <div class="row">
                                                        <div class="col">
                                                            ...
                                                            <span>YES</span>
                                                            <input type="checkbox" name="g2n" value="no"
                                                                <?= isset($lifechangerform['g2n']) && $lifechangerform['g2n'] === 'no' ? 'checked' : '' ?>>
                                                            <span>NO</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-8">
                                                    <div class="row">
                                                        <label for="">Have you ever declared bankruptcy and/or have you
                                                            ever been declared bankruptcy by
                                                            regulators/authorities? If yes, please provide
                                                            details:<input class="" type="text" name="bankruptcy" id=""
                                                ...
                                                <div class="col-3 justify-content-center text-center">
                                                    <div class="row">
                                                        <div class="col">
                                                            ...
                                                            <span>YES</span>
                                                            <input type="checkbox" name="g3n" value="no"
                                                                <?= isset($lifechangerform['g3n']) && $lifechangerform['g3n'] === 'no' ? 'checked' : '' ?>>
                                                            <span>NO</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-8">
                                                    <div class="row">
                                                        <label for="">Have you ever been investigated for any
                                                            administrative case?
                                                            If yes, please provide details:<input class="tb" type="text"
                                                                name="investigated" id=""
                                            ...
                                            <div class="row">
                                                <div class="col-3 justify-content-center text-center">
                                                    <div class="row">
                                                        <div class="col">
                                                            ...
                                                            <span>YES</span>
                                                            <input type="checkbox" name="g4n" value="no"
                                                                <?= isset($lifechangerform['g4n']) && $lifechangerform['g4n'] === 'no' ? 'checked' : '' ?>>
                                                            <span>NO</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-8">
                                                    <div class="row">
                                                        <label for="">Have you ever been terminated or forced to resign
                                                            from any employment or affiliates of any Insurance
                                                            Company or Financial Institution? If yes, please provide
                                                            details:<input class="" type="text" name="terminated" id=""
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <ul style="margin-top: 10px;">
                                                        <li>to use and process, whether manually or via electronic
                                                            ...
                                                            including Personal and Sensitive Personal Information, to
                                                            facilitate, monitor, and improve matters pursuant to my
                                                            application.</li>
                                                        <li>to share, transfer, and/or disclose the said information to
                                                            any of its intermediaries, subsidiaries, affiliates, service
                                                            providers, partners and government agencies for the said
                                                            purposes.</li>
                                                        <li>I likewise promise to inform Allianz PNB Life Insurance,
                                                            Inc. of any change relating to my personal information.</li>
                                                    </ul>
                                                    <p style="text-indent: 20px;">I further understand and acknowledge
                                                        that such Personal Information may be used by AZPNBL to comply
                                                        with its legal or regulatory obligations under applicable local
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div style="border: 1px solid #ccc; padding: 10px;">
                                                        <p>I declare that all information supplied above and all other
                                                            ...
                                                            supplied may result in rejection of this application or if
                                                            already accepted termination of my contract. I agree that a
                                                            photographic copy of this authorization and waiver shall be
                                                ...
                                                <div class="col-6">
                                                    <div class="row">
                                                        <div class="col">
                                                            ...
                                                            <label for="printedName" style="font-size: 10pt">Applicant's
                                                                Printed Name</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-5">
                                                    <div class="w-75" style="border-bottom: 1px solid black" id="signature"></div>
                                                    <input type="hidden" name="sign" id="sign" value="<?= isset($lifechangerform['signature']) ? $lifechangerform['signature'] : '' ?>">
                                                    <label for="signature">Signature</label>
                                                    <button class="btn btn-danger btn-sm m-1" type="button" onclick="clearSignature()">Clear</button>
                                                </div>
                                                <div class="col-lg-5">
                                                <div id="signaturePreview">
                                                    <img id="signatureImage" src="<?= isset($lifechangerform['signature']) ? base_url('uploads/signatures/' . $lifechangerform['signature']) : '' ?>">
                                                </div>
