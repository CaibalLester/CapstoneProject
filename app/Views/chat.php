                            ...
                            <div class="modal-content">
                                <div class="chat-header">
                                    <div class="msg-search">
                                        ...
                                        <a class="add" href="#"><i class="bi-search"></i>
                                        </a>
                                    </div>
                                    ...
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link active" id="Agent-tab" data-bs-toggle="tab"
                                                data-bs-target="#Agent" type="button" role="tab" aria-controls="Agent"
                                                aria-selected="true">Agent</button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="Applicant-tab" data-bs-toggle="tab"
                                                data-bs-target="#Applicant" type="button" role="tab"
                                                aria-controls="Applicant" aria-selected="false">Applicant</button>
                                        </li>
                                    </ul>
                                </div>
