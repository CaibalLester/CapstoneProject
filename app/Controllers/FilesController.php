...
class FilesController extends BaseController
{
    ...
    //     $data['files'] = $this->file->where('user_id', $userId)->findAll();
    ...
    //         $newFileName = $file1->getRandomName();
    //         $file1->move($uploadPath, $newFileName);
    //         $fileData['file1'] = 'file1_'.$newFileName;
    //     }

    //     if ($file2->isValid() && !$file2->hasMoved()) {
    //         $newFileName = $file2->getRandomName();
    //         $file2->move($uploadPath, $newFileName);
    //         $fileData['file2'] = 'file2_' . $newFileName;
    //     }

    //     if ($file3->isValid() && !$file3->hasMoved()) {
    //         $newFileName = $file3->getRandomName();
    //         $file3->move($uploadPath, $newFileName);
    //         $fileData['file3'] = 'file3_' . $newFileName;
    //     }

    //     if ($file4->isValid() && !$file4->hasMoved()) {
    //         $newFileName = $file4->getRandomName();
    //         $file4->move($uploadPath, $newFileName);
    //         $fileData['file4'] = 'file4_' . $newFileName;
    //     }

    //     if ($file5->isValid() && !$file5->hasMoved()) {
    //         $newFileName = $file5->getRandomName();
    //         $file5->move($uploadPath, $newFileName);
    //         $fileData['file5'] = 'file5_' . $newFileName;
    //     }

    //     if ($file6->isValid() && !$file6->hasMoved()) {
    //         $newFileName = $file6->getRandomName();
    //         $file6->move($uploadPath, $newFileName);
    //         $fileData['file6'] = 'file6_' . $newFileName;
    //     }
